		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-5 col-md-12">
					...
					<p>Exploit the world's award-winning content management system (CMS) using world-class Joomla development services by an outstanding team of Joomla developers at Briskstar Technologies.
					</p>
		...
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="col-lg-6 col-md-12">
					...
					<p>You will get an edge over your competition and realize a high ROI. We make it possible through our years of experience and expertise in Joomla development. We will win the hearts of your end-users by offering exceptional user experiences, unbeatable performance, and awesome usability. The following are our comprehensive Joomla development services. </p>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-12">
					<div class="key-benefits-card">
						...
						<p>We have invested heavily in creating Joomla development facilities, including hardware, software, and networking. Our solo aim is to develop a collaborative Joomla development environment to foster productivity.
						</p>
					</div>
				</div>
				<div class="col-lg-4 col-md-12">
